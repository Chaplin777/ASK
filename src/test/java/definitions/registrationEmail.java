...
public class registrationEmail {
    ...
    @And("I type confirmation password {string}")
    public void iTypeConfirmationPassword(String confPass) {
    ...
    public void textAppears(String text) throws InterruptedException {
        ...
        //WebElement expectedText=getDriver().findElement(By.xpath("//*[contains(text(),'You have been Registered.')]"));
